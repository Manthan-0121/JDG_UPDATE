...
function addWebLink(title = '', subtitle = '', url = '') {
    ...
    <div class="mb-3 link-group" id="${linkId}">
        ...
        <input type="text" class="form-control mb-1 link-title" placeholder="Title" value="${title}" oninput="updatePreview()">
        <input type="text" class="form-control mb-1 link-subtitle" placeholder="Sub-title" value="${subtitle}" oninput="updatePreview()">
        <input type="url" class="form-control link-url" placeholder="http://example.com" value="${url}" oninput="updatePreview()">
    </div>`;
