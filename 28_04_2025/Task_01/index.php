    ...
    <div class="centered-form">
        <form class="form-card" id="user_info_form">
            ...
            <div class="mb-3 anim_01" id="stage_one" z>
                ...
                <div id="fname_error" class="text-danger" style="display: none;">Please enter a valid name (letters only)</div>
            </div>
            ...
            <div class="mb-3 anim_02" id="stage_two" style="display: none;">
                ...
                <div id="lname_error" class="text-danger" style="display: none;">Please enter last name. (letters only)</div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#user_info_form').on('submit', function(e) {
                ...
                // set data using sessionStorage
                // sessionStorage.setItem("fname", txt_fname);
                // sessionStorage.setItem("lname", txt_lname);
                // sessionStorage.setItem("email", txt_email.toLowerCase());
                // sessionStorage.setItem("mobile", txt_mobile);
                // if(txt_hobbies == "other") {
                //     sessionStorage.setItem("hobbies", txt_ddl_other.value);
                // } else {
                //     sessionStorage.setItem("hobbies", txt_hobbies);
                // }
                // sessionStorage.setItem("skills", selectedValues.join(", "));


                // set data using cookies
                document.cookie = "fname=" + txt_fname;
                document.cookie = "lname=" + txt_lname;
                document.cookie = "email=" + txt_email.toLowerCase();
                document.cookie = "mobile=" + txt_mobile;

                if (txt_hobbies == "other") {
                    document.cookie = "hobbies=" + txt_ddl_other.value;
                } else {
                    document.cookie = "hobbies=" + txt_hobbies;
                }
                document.cookie = "skills=" + selectedValues.join(", ");

                // get data using cookies and store in cookies variable
                cookie_data= document.cookie.split('; ').reduce((acc, cookie) => {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 1) {
                            ...
                            // get data using sessionStorage
                            // $('#model_fname').text(sessionStorage.getItem("fname"));
                            // $('#model_lname').text(sessionStorage.getItem("lname"));
                            // $('#model_email').text(sessionStorage.getItem("email"));
                            // $('#model_mobile').text(sessionStorage.getItem("mobile"));
                            // $('#model_hobby').text(sessionStorage.getItem("hobbies"));
                            // $('#model_skills').text(sessionStorage.getItem("skills"));

                            // clear sessionStorage
                            // sessionStorage.clear();
                            
                            // get data using cookies
                            $('#model_fname').text(cookie_data.fname);
                            $('#model_lname').text(cookie_data.lname);
                            $('#model_email').text(cookie_data.email);
                            $('#model_mobile').text(cookie_data.mobile);
                            $('#model_hobby').text(cookie_data.hobbies);
                            $('#model_skills').text(cookie_data.skills);

                            // clear data using cookies
                            document.cookie = "fname=;";
                            document.cookie = "lname=;";
                            document.cookie = "email=;";
                            document.cookie = "mobile=;";
                            document.cookie = "hobbies=;";
                            document.cookie = "skills=;";
