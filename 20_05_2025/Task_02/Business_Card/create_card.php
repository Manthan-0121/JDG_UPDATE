                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="whatsapp" oninput="updateSocialLinks()">

                                <label>Linkedin</label>
                                <input type="text" class="form-control" id="linkedin" oninput="updateSocialLinks()">

                                <label>Instagram</label>
                                <input type="text" class="form-control" id="instagram" oninput="updateSocialLinks()">

                                <label>Twitter</label>
                                <input type="text" class="form-control" id="twitter" oninput="updateSocialLinks()">

                                <label>Youtube</label>
                                <input type="text" class="form-control" id="youtube" oninput="updateSocialLinks()">

                                <label>Skype</label>
                                <input type="text" class="form-control" id="skype" oninput="updateSocialLinks()">

                                <label>Google Map</label>
                                <input type="text" class="form-control" id="googlemap" oninput="updateSocialLinks()">
