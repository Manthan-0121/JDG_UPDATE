...
function stage_one() {
    ...
    document.getElementById("stage_one").style.transition = 'transform 2s';
    document.getElementById("stage_one").style.transform = "translateY(-500px)";
    setTimeout(() => {
        document.getElementById("stage_one").style.display = "none";
    }, 500);
    setTimeout(() => {
...
function stage_two() {
    ...
    document.getElementById("stage_two").style.transition = 'transform 2s';
    document.getElementById("stage_two").style.transform = "translateY(500px)";
    setTimeout(() => {
...
function stage_three() {
    ...
    document.getElementById("stage_three").style.transition = 'transform 2s';
    document.getElementById("stage_three").style.transform = "translateX(-500px)";
...
function stage_four() {
    ...
    document.getElementById("stage_four").transition = 'transform 2s';
    document.getElementById("stage_four").transform = "translateX(500px)";
...
function stage_five() {
    ...
    document.getElementById("stage_five").style.transition = 'transform 2s';
    document.getElementById("stage_five").style.transform = "translateY(-500px)";
    setTimeout(() => {
